...
In spite of this, NTDs have historically ranked very low and almost absent from the global health policy agenda - only to gain recognition in 2015 with the Sustainable Development Goals (SDG target 3.3). SDG3 can therefore be achieved only if the NTD goals are met but, because interventions to tackle NTDs are widely cross-sectoral, increasing their global prioritization can in fact catalyse progress to achieve all SDGs (WHO no date b). As a result, neglected tropical diseases trap the poor in a cycle of poverty and disease (WHO, no date).
At present, the World Health Organization (WHO) categorizes the following group of conditions as NTDs which are caused by a variety of pathogens, (including Viruses, Bacteria, parasites, fungi and toxins) (WHO, no date a)as including:
